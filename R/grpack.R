...
##' @docType package
##' @title grpack
##' @import sandwich Rcpp RcppArmadillo Hmisc lmtest stringr
##' @keywords package
##' @useDynLib grpack
NULL
##' auto dataset from stata
##' 
##' @name auto
##' @docType data
##' @format A dataframe with 74 observations on the following 12 variables
##'
##' \describe{
##'
##' \item{"make"}{maker of car.}
##' 
##' \item{"price"}{price of car.}
##'
